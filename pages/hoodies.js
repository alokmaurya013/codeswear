      ...
      <section className='text-gray-600 body-font min-h-screen'>
         <div className='container px-5 py-24 mx-auto'>
          <div className='flex flex-wrap m-4 justify-center mx-5'>
            { Object.keys(products).length==0&&<p>Sorry all the Hoddies are currently out of stack.New stack comming soon!</p>}
             { Object.keys(products).map((item)=>{
             return <Link key={products[item]._id} passHref={true} href={`/product/${products[item].slug}`}><div className='lg:w-1/5 md:w-1/2 p-4 w-full curor-pointer shadow-lg m-5'>
